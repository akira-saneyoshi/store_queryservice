...
type productServer struct {
	...
	v1.UnimplementedProductQueryServer
}

// コンストラクタ
func NewproductServerImpl(repository products.ProductRepository, builder builder.ResultBuilder) v1.ProductQueryServer {
	return &productServer{repository: repository, builder: builder}
}

// すべての商品を取得して返す(Server streaming RPC)
func (ins *productServer) ListStream(param *emptypb.Empty, stream v1.ProductQuery_ListStreamServer) error {
...
// すべての商品を取得して返す
func (ins *productServer) List(ctx context.Context, param *emptypb.Empty) (*v1.ProductsResult, error) {
...
// 指定されたIDの商品を取得して返す
func (ins *productServer) ById(ctx context.Context, param *v1.ProductParam) (*v1.ProductResult, error) {
...
func (ins *productServer) ByKeyword(ctx context.Context, param *v1.ProductParam) (*v1.ProductsResult, error) {
